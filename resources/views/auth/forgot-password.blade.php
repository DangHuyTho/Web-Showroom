...
<div style="min-height: 100vh; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #1a1a1a 0%, #2d2d2d 100%);">
    <div style="width: 100%; max-width: 400px; padding: var(--spacing-md);">
        ...
        <div style="text-align: center; margin-bottom: var(--spacing-lg);">
            <h1 style="font-size: 2rem; font-weight: 700; color: var(--color-secondary); font-family: 'Playfair Display', serif;">Quên Mật Khẩu</h1>
            <p style="color: rgba(255,255,255,0.6); margin-top: var(--spacing-sm);">Nhập tên đăng nhập của bạn để nhận mã xác nhận</p>
        </div>
