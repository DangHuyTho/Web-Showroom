...
<div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        ...
        <!-- Form -->
        <form method="POST" action="{{ route('admin.inspiration-posts.store') }}" enctype="multipart/form-data" class="space-y-8">
            @csrf
            ...
            <div class="bg-white rounded-lg shadow p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="excerpt" rows="3" 
                              ...
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 @error('excerpt') border-red-500 @enderror">{{ old('excerpt') }}</textarea>
                ...
                <div>
                    ...
                    <select name="post_type" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 @error('post_type') border-red-500 @enderror">
                        ...
                        <option value="{{ $type }}" {{ old('post_type') === $type ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center cursor-pointer hover:bg-gray-50" onclick="document.getElementById('featured-image').click()">
                        ...
                        <p class="text-gray-600 font-medium">Nhấp để tải hình ảnh</p>
            ...
            <div class="bg-white rounded-lg shadow p-6 space-y-4">
                ...
                <div>
                    ...
                    <textarea name="content" rows="10" 
                              required
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 font-mono text-sm @error('content') border-red-500 @enderror">{{ old('content') }}</textarea>
            ...
            <div class="bg-white rounded-lg shadow p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="project_location" value="{{ old('project_location') }}" 
                               maxlength="255"
